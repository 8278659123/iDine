...
struct ContentView: View {
    ...
    var body: some View {
        ...
        NavigationView {
            ...
            //Here we are first using the MenuSelection to display the name of one of the selection (Ex.Breakfast) then we display all the MenuItems in the items array using the section.items.
            List {
